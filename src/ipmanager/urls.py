...
from ipmanager.ui.views import HomeView, GroupListView, SingleGroupView, EditGroupView, CreateGroupView, DeleteGroupView, CreateRelationView, DeleteRelationView, CreateIPRangeView, DeleteIPRangeView
