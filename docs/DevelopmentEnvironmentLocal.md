...
This document provides guidance on setting up an IPManager Django development
...
3. Retrieve the SAML Key and Cert information. The cert file can be accessed
   through Box. Alternatively, you can pull the key and cert from the
   Kubernetes cluster into files using the following commands:
...
5. Initialize the database:
    ...
    ```
6. Run the application. The default port is 3001; this is also the port that
